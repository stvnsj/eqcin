...
const {proyectosDictionary}= require("../repositories/index")
...
exports.dictionary  = asyncHandler(async (req, res) => {
    const rows = await proyectosDictionary ();
...
exports.getEmpleados = (req, res, next) => {
	...
	const SQL = `
		...
		SELECT 
		nombre_completo(E.id) as nombre,
		E.rut,
		E.id,
        P.activo
		FROM empleados E
