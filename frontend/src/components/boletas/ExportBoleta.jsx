...
export default function ExportBoleta(){
  ...
  useEffect(()=>{
    ...
    const url = `http://localhost:8000/boleta/xport/${year}`;
  ...
  useEffect(()=>{
    ...
    const url = `http://localhost:8000/boleta/detalle/${date1}/${date2}/${option}`;
