...
export default function DownloadCosto(){
	...
	return `Bol_Fac_Trans_${timeRange}`;
    }
	...
	const url = `http://localhost:8000/costo/full/${date1}/${date2}/${option}`;
	...
	fetch(url,requestOptions)
		...
		a.href = url;
		a.download = `costos_${date1}_${date2}` + '.xlsx' ;
		a.click();
